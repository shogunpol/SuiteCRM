...
class FP_eventsController extends SugarController
{
    ...
    public function action_accept_report()
    {
        $this->view = "accept";
    }
    ...
    public function action_sendinvitemails(){
        ...
        foreach ($event->fp_events_contacts->getBeans() as $contact) {
            ...
            if($status == null || $status == '' || $status == 'Not Invited'){
                ...
                $invite_count ++;
                //set email links
                $event->link = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$contact->id."&type=c&response=accept'>{$mod_strings['LBL_EMAIL_ACCEPT']}</a>";
                $event->link_declined = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$contact->id."&type=c&response=decline'>{$mod_strings['LBL_EMAIL_DECLINE']}</a>";
        ...
        foreach ($event->fp_events_prospects_1->getBeans() as $target) {
            ...
            if($status == null || $status == '' || $status == 'Not Invited'){
                ...
                //set email links
                $event->link = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$target->id."&type=t&response=accept'>{$mod_strings['LBL_EMAIL_ACCEPT']}</a>";
                $event->link_declined = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$target->id."&type=t&response=decline'>{$mod_strings['LBL_EMAIL_DECLINE']}</a>";
        ...
        foreach ($event->fp_events_leads_1->getBeans() as $lead) {
            ...
            if($status == null || $status == '' || $status == 'Not Invited'){
                ...
                $invite_count ++;
                //set email links
                $event->link = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$lead->id."&type=l&response=accept'>{$mod_strings['LBL_EMAIL_ACCEPT']}</a>";
                $event->link_declined = "<a href='".$sugar_config['site_url']."/index.php?entryPoint=responseEntryPoint&event=".$event->id."&delegate=".$lead->id."&type=l&response=decline'>{$mod_strings['LBL_EMAIL_DECLINE']}</a>";
